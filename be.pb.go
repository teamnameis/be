...
func init() {
	proto.RegisterType((*Frame)(nil), "be.Frame")
}
...
var fileDescriptor_dbad8e6386660096 = []byte{
	...
	0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4a, 0x4a, 0x55, 0xd2, 0xe6, 0x62, 0x75, 0x2b, 0x4a, 0xcc,
	...
	0xd4, 0x24, 0x36, 0xb0, 0xb3, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xfd, 0xbd, 0x3d, 0xc1,
	0xa2, 0x00, 0x00, 0x00,
}
...
func (x *overlaySendClient) Send(m *Frame) error {
	return x.ClientStream.SendMsg(m)
}

func (x *overlaySendClient) Recv() (*Frame, error) {
	m := new(Frame)
...
func (x *overlaySendServer) Send(m *Frame) error {
	return x.ServerStream.SendMsg(m)
}

func (x *overlaySendServer) Recv() (*Frame, error) {
	m := new(Frame)
