...
bench/agent/stream: \
	ngt/install
	$(call bench-pprof,pprof/be,agent,gRPCStream,stream,\
		./hack/benchmark/e2e/be/ngt_bench_test.go \
		 -dataset=$(DATASET_ARGS) -address=$(ADDRESS_ARGS))

.PHONY: bench/agent/sequential/grpc
bench/agent/sequential/grpc: \
	ngt/install
	$(call bench-pprof,pprof/be,agent,gRPCSequential,sequential-grpc,\
		./hack/benchmark/e2e/be/ngt_bench_test.go \
		 -dataset=$(DATASET_ARGS) -address=$(ADDRESS_ARGS))
...
bench/agent/sequential/rest: \
	ngt/install
	$(call bench-pprof,pprof/be,agent,RESTSequential,sequential-rest,\
		./hack/benchmark/e2e/be/ngt_bench_test.go \
		 -dataset=$(DATASET_ARGS) -address=$(ADDRESS_ARGS))
...
profile/agent/stream:
	$(call profile-web,pprof/be,agent,stream,":6061",":6062",":6063")

.PHONY: profile/agent/sequential/grpc
profile/agent/sequential/grpc:
	$(call profile-web,pprof/be,agent,sequential-grpc,":6061",":6062",":6063")

.PHONY: profile/agent/sequential/rest
profile/agent/sequential/rest:
	$(call profile-web,pprof/be,agent,sequential-rest,":6061",":6062",":6063")
